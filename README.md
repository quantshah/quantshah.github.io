...
I am Shahnawaz Ahmed, currently a deep learning researcher exploring how large neural networks can be compressed to run on embedded systems at [Embedl](https://embedl.com). I completed my Ph.D. at the Wallenberg Centre for Quantum Technology, Chalmers University of Technology, Göteborg. My research focuses on the intersection of quantum information, computing, and machine learning. I am interested in exploring the merger of these fields, with a particular emphasis on applying machine-learning techniques to solve problems in quantum physics. I am also involved with quantum machine learning research at [Xanadu AI](https://xanadu.ai) working with the group of Dr. Maria Schuld on benchmarking quantum vs classical machine learning.
